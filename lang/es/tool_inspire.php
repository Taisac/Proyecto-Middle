...
$string['indicator:exerciseactions'] = 'Acciones sobre ejercicios';
...
$string['indicator:viewedactions'] = 'Lectura de acciones';
$string['indicator:tevaluation'] = 'Tiempo de evaluacion';
$string['indicator:actionmessage'] = 'Interaccion por mensaje';
$string['indicator:readingjumps'] = 'Saltos de lectura';
$string['indicator:textactivities'] = 'Actividades textuales';
$string['indicator:auditiveactivities'] = 'Actividades auditivas';
$string['indicator:multimediaactivities'] = 'Actividades multimedia';
...
$string['target:perceptiondimension'] = 'Dimensión Percepción (Intuitivo/Sensitivo)';
$string['target:inputdimension'] = 'Dimensión Entrada (Visual/Auditivo)';
$string['target:prosecutiondimension'] = 'Dimensión Procesamiento (Activo/Reflectivo)';
$string['target:understandingdimension'] = 'Dimensión Entendimiento (Secuencial/Global)';
$string['target:coursedropout'] = 'Dimensión prueba';
