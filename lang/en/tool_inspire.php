...
$string['indicator:exerciseactions'] = 'Exercise actions amount';
...
$string['indicator:viewedactions'] = 'Viewed actions';
$string['indicator:tevaluation'] = 'Time evaluation';
$string['indicator:actionmessage'] = 'Action message';
$string['indicator:readingjumps'] = 'Reading jumps';
$string['indicator:textactivities'] = 'Only text activities';
$string['indicator:auditiveactivities'] = 'Auditive activities';
$string['indicator:multimediaactivities'] = 'Multimedia activities';
...
$string['target:perceptiondimension'] = 'Perception Dimension (Intuitive/Sensitive)';
$string['target:inputdimension'] = 'Input Dimension (Visual/Auditive)';
$string['target:prosecutiondimension'] = 'Prosecution Dimension (Active/Reflective)';
$string['target:understandingdimension'] = 'Understanding Dimension (Global/Sequential)';
$string['target:coursedropout'] = 'Dimensión 2 (Intuitivo/Sensitivo)';
