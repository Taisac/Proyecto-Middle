 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class action_message extends binary {
    ...
    public function calculate_sample($sampleid, $sampleorigin, $starttime = false, $endtime = false) {
        ...
        return 2;
//$DB->record_exists_select('logstore_standard_log', $select, $params) ? self::get_max_value() : self::get_min_value();
    }
}
